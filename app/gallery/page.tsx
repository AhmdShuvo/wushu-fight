    ...
    return (
        <div className="gallery-page-root">
                ...
                <div className="container">
                    ...
                    {loading ? (
                        <div className="text-center py-120">
                            <div className="spinner-border text-danger lg"></div>
            ...
            <style jsx global>{`
                ...
                .bento-tag { color: #e80000; font-weight: 800; font-size: 11px; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 5px; }
                ...
                .bento-pill.active { background: #e80000; color: #fff; box-shadow: 0 4px 15px rgba(232,0,0,0.2); }
                ...
                .bento-cat-text { color: #e80000; font-weight: 900; letter-spacing: 2px; font-size: 12px; text-transform: uppercase; margin-top: 5px; }
                ...
                .bento-page-dot.active { border-radius: 50%; background: #e80000; border-color: #e80000; color: #fff; }
