...
interface MediaPickerProps {
    ...
    type?: 'image' | 'pdf' | 'video' | 'all';
    label?: string;
}

export default function MediaPicker({ value, onChange, type = 'all', label = 'Asset Selector' }: MediaPickerProps) {
                        ...
                        <div className="tab-content flex-grow-1 overflow-auto">
                            {activeTab === 'upload' ? (
                                <div className="text-center py-5">
                                    <div className="upload-dropzone p-5 border-dashed rounded" style={{ border: '2px dashed #444', backgroundColor: '#1a1a1a' }}>
                                        ...
                                        <p className="text-muted small">Supports Images, PDFs, and Video clips</p>
                                        <input 
                                            type="file" 
                                            ...
                                            {library.map((item) => (
                                                <div className="col-lg-3 col-md-4 col-6" key={item._id}>
                                                    <div 
                                                        ...
                                                        onClick={() => { onChange(item.url); setShowModal(false); }}
                                                    >
